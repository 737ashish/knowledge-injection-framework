...
class MendRewriteExecutor:
    ...
    def init_model(self, model, tok, params):
        ...
        if params.model_name == "gpt2-medium":
            modelcode = "gpt2medium" 
        elif params.model_name == "gpt2-large":
            modelcode = "gpt2large"
        elif params.model_name == "gpt2-xl":
            modelcode = "gpt2xl"
        elif params.model_name == "gpt-j-6b":
            modelcode = "gptj"
        else:
            raise NotImplementedError("Model not supported.")
        
        model_filename = (f"mend-{mini_string}{params.n_toks}tok-{train_ds}{params.model_name}.pt")
        model_dir = "data/mend/weights"
        ...
        with hydra.initialize(config_path="config", job_name="run", version_base="1.1"):
